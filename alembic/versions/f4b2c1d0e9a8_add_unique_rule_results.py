"""add unique constraint on rule_evaluation_results (audit_id, page_id, rule_id)
...
(ON CONFLICT (audit_id, page_id, rule_id) DO UPDATE).

NOTE: if a pre-existing database has duplicate (audit_id, page_id, rule_id)
