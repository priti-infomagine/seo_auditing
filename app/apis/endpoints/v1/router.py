...
from app.apis.endpoints.v1.crawler.router import router as crawler_router
from app.apis.endpoints.v1.parser.router import router as parser_router
from app.apis.endpoints.v1.audit.router import router as audit_router
from app.apis.endpoints.v1.scorer.router import router as scorer_router
