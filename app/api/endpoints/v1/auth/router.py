...
from app.api.endpoints.v1.auth.register import router as register_router
from app.api.endpoints.v1.auth.login import router as login_router
from app.api.endpoints.v1.auth.verify_otp import router as verify_otp_router
...
from app.api.endpoints.v1.auth.forgot_pass import router as password_reset_router
